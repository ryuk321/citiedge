...
// Create a global state for showing/hiding the modal
let globalShowAddStudent: (() => void) | null = null;
let globalRefreshStudents: (() => void) | null = null;

export const showAddStudentModal = () => {
  if (globalShowAddStudent) {
    globalShowAddStudent();
  }
};

export const setStudentsRefreshCallback = (callback: () => void) => {
  globalRefreshStudents = callback;
};
...
const AddStudent: React.FC = () => {
  ...
  const handleAddStudent = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}?action=add`,
        {
          method: 'POST',
          headers: {
  ...
  return (
<div className="fixed inset-0 flex items-center justify-center z-50 p-4">      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-hidden flex flex-col">
        {/* Modal Header */}
                ...
                <div className="lg:col-span-3">
                  <label className="flex flex-col">
                    ...
                    <input
                      ...
                      className="px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black bg-gray-50 font-mono text-lg"
                      required
                    />
